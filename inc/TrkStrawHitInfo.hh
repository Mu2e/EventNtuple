...
namespace mu2e
{
  struct TrkStrawHitInfo {
    ...
    float ulresid = 0, ulresidmvar = -1.0, ulresidpvar = -1.0; // unbiased distance residual and associated measurement and parameter variances
    ...
    float rlresid = 0, rlresidmvar = -1.0, rlresidpvar = -1.0; // reference time residual and associated measurement and parameter variances
